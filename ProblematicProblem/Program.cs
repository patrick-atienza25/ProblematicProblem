...
namespace ProblematicProblem
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            seeList = (userInput2.ToLower() == "sure") ? true : false;
            if (seeList)
            {
                ...
                addToList = (userInput3.ToLower() == "yes") ? true : false;
                Console.WriteLine();
                ...
                while (addToList == true)
                {
                    ...
                    addToList = (userInput4.ToLower() == "no") ? false : true;
                }
            }
            ...
            while (cont)
            {
                ...
                cont = (userInput5.ToLower() == "redo") ? true : false;
            }
        }
    }
}
